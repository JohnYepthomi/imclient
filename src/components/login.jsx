...
import { authenticateUser, saveCredential, logout } from '../features/messages/authSlice';
...
export default function Login() {
  ...
  const authProcess = () => {
    if(!loggedOut && !activeClient){
      ...
      dispatch(authenticateUser({username: credential[0].username, password: credential[0].password}));
      setSubmitted(true);
    }
  };
      ...
      <div className="login-body">
          ...
          <div className="login-form">
              <div className="login-form-input">
                  ...
                  <input type="text" id="username" name="username" placeholder="enter your user id" ref={usernameRef}/>
              </div>
              <div className="login-form-input">
